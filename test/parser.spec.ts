...
function test_parser_01() {
    ...
    ST.register("test_parser_01 P1", () => t(P1))
    ST.register("test_parser_01 P2", () => t(P2))
}
test_parser_01()
...
function define_tests() {
    const test_definitions = [
        function define_number_tests() {
            ...
            ST.register("parser_number P1", () => t(P1))
            ST.register("parser_number P1", () => t(P2))
        },
        ...
        function define_brackets_tests() {
            ...
            ST.register("test_bracket_parser P1", () => t(P1))
            ST.register("test_bracket_parser P1", () => t(P2))
        },
        ...
        function define_all_factor_and_term_tests() {
            ...
            ST.register("factor_and_term P1", () => t(P1))
        },
        ...
        function define_term_and_expression_tests() {
            ...
            ST.register("term and expression P1", () => t(P1))
            ST.register("term and expression P1", () => t(P2))
        },
        function define_expression_tests() {
            ...
            ST.register("expression_tests P1", () => t(P1))
        },
    ]
